...
// ============================================
const CONTRACT_ADDRESS = "0x4Ee7f03817Bf688c076B85c717f4bdE69d20ab54" // Replace with your deployed contract
const CONTRACT_ABI = [
	{
		"inputs": [],
		"name": "deposit",
...
// FUNÇÃO PARA PUXAR DADOS REAIS DA BLOCKCHAIN
const refreshData = async (userAddress) => {
...
<div className="flex gap-6 text-sm"> <div><span className="text-white/40">ARC:</span> <span className="font-semibold">{arcBalance}</span></div> <div><span className="text-white/40">USDC:</span> <span className="font-semibold">{walletBalances.USDC}</span></div> <div><span className="text-white/40">EURC:</span> <span className="font-semibold">{walletBalances.EURC}</span></div> </div> </div> </div> )}
text
